...
p_lat_median = ds.lat_median.hvplot(x='time', y='height', cmap='cividis_r', ylim=(0,10000), clim=(45,85), clabel='Median Latitude', height=300, responsive=True).opts(title='HYSPLIT-5 Back Trajectories for Raven Camp 2024')
p_alt_min    = ds.alt_min.hvplot(x='time', y='height', cmap='cividis_r', ylim=(0,10000), clim=(0,10000), clabel='Minimum Altitude', height=300, responsive=True)
p_dTheta     = ds.dTheta.hvplot(x='time', y='height', cmap='RdBu_r', ylim=(0,10000), clim=(-30,30), clabel='delta(Theta)', height=300, responsive=True)
p_q_mean     = ds.q_mean.hvplot(x='time', y='height', cmap='Blues', ylim=(0,10000), clabel='Specific Humidity (g/kg)', height=300, responsive=True)
p_dq         = ds.dq.hvplot(x='time', y='height', cmap='RdBu', ylim=(0,10000), clim=(-10,10), clabel='delta(q) (g/kg)', height=300, responsive=True)
